...
// #define EXAMPLE_ADC1_CHAN0          ADC_CHANNEL_4 // GPIO D32
...
//     int a =1;
//     int * buf = &a;
//     adc_oneshot_channel_to_io(ADC_UNIT_1, ADC_CHANNEL_2,buf );
//     ESP_LOGI(TAG, "ADC_UNIT_1, ADC_CHANNEL_2 GPIO: %d", *buf);

//     adc_oneshot_channel_to_io(ADC_UNIT_1, ADC_CHANNEL_3,buf );
//     ESP_LOGI(TAG, "ADC_UNIT_1, ADC_CHANNEL_3 GPIO: %d", *buf);
    
//     adc_oneshot_channel_to_io(ADC_UNIT_1, ADC_CHANNEL_4,buf );
//     ESP_LOGI(TAG, "ADC_UNIT_1, ADC_CHANNEL_4 GPIO: %d", *buf);
    
//     adc_oneshot_channel_to_io(ADC_UNIT_1, ADC_CHANNEL_5,buf );
//     ESP_LOGI(TAG, "ADC_UNIT_1, ADC_CHANNEL_5 GPIO: %d", *buf);
